        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12 col-lg-8">
              <img src="../../assets/images/slider-1-1200x900.jpg" alt="">
              ...
              <div class="sided-70 mb-40">
                ...
                <div class="s-left rounded">
                  <img src="../../assets/images/profile-3-120x120.jpg" alt="">
                </div><!-- s-left -->
              ...
              <div class="sided-70 ml-100 ml-xs-20 mb-40">
                ...
                <div class="s-left rounded">
                  <img src="../../assets/images/profile-1-120x120.jpg" alt="">
                </div><!-- s-left -->
              ...
              <div class="sided-70 mb-50">
                ...
                <div class="s-left rounded">
                  <img src="../../assets/images/profile-2-120x120.jpg" alt="">
                </div><!-- s-left -->
              ...
              <div class="pl-20 pl-md-0">
                ...
                <div class="mtb-50">
                  ...
                  <a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
                    <div class="wh-100x abs-tlr"><img src="../../assets/images/polular-1-100x100.jpg" alt=""></div>
                  ...
                  <a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
                    <div class="wh-100x abs-tlr"><img src="../../assets/images/polular-2-100x100.jpg" alt=""></div>
                    <div class="ml-120 min-h-100x">
                      <h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
                      <h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
                    </div>
                  ...
                  <a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
                    <div class="wh-100x abs-tlr"><img src="../../assets/images/polular-3-100x100.jpg" alt=""></div>
                    <div class="ml-120 min-h-100x">
                      <h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
                      <h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
                    </div>
                  ...
                  <a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
                    <div class="wh-100x abs-tlr"><img src="../../assets/images/polular-4-100x100.jpg" alt=""></div>
                    <div class="ml-120 min-h-100x">
                      <h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
                      <h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
                    </div>
